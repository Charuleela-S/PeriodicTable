...
def login_user():
    if username.get() == '' or password.get() == '':
        ...
        if result_password:
            hashed_password = result_password[0]  # This should be a bytes object
            print("Hashed password retrieved:", hashed_password)  # Debugging

            # Ensure hashed_password is of type bytes
